...
export default function Contact() {
  ...
  return (
    <>
      <div className="p-8 flex relative mb-10 justify-center">
        <div className=" grid grid-cols-1 md:grid-cols-2 bg-white rounded-md shadow-md lg:mx-14  max-w-[900px] mx-auto z-20">
          <div className="p-6 mr-2 bg-white sm:rounded-lg">
            ...
            <div className="flex items-center mt-2 text-gray-600 dark:text-gray-400">
              ...
              <Link
                href={'mailto:contato@nexteats.com.br'}
                className="ml-4 text-md tracking-wide font-semibold w-40"
              >
                contato@nexteats.com.br
              </Link>
            </div>
          </div>
