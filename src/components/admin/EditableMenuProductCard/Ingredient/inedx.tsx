...
export function Igredient({ state, dispatch }: iIgradientsCardProps) {
    ...
    return (
        <div>
            <form onSubmit={handleSubmit(handleIngredient)} className="w-full flex items-center justify-between">
