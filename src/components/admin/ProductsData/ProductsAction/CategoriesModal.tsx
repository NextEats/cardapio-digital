  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="data-[state=open]:animate-contentShow fixed top-0 right-0 3xs:top-[40%] 3xs:left-[50%] h-screen 3xs:h-[500px] w-screen 
          ...
          <div className="flex flex-wrap 2md:justify-start justify-center gap-3">
            {(categoryType === 'product_category'
              ...
              return (
                <div
                  key={category.id}
                  className="w-full 3xs:w-[200px] h-[70px] p-2 rounded-sm bg-white shadow-sm"
                >
                  <div className="flex justify-between ">
                    <span className=" w-full mr-11 3xs:w-[160px] truncate">
                      {' '}
                      {category.category_order}° - {category.name}{' '}
                    </span>
                  ...
                  <span>
                    {' '}
                    {categoryType === 'product_category' ? count : null}{' '}
                  </span>
                </div>
              );
            })}
