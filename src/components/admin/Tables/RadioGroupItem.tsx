...
export default function RadioGroupItem({ value, id, label, lableClassName }: iRadioGroupItemProps) {
    return (
        <div className="flex items-center">
            ...
            <label className={`text-base font-medium leading-none pl-[15px] ${lableClassName}`} htmlFor={id}>
                {label}
            </label>
        </div>
    )
