...
//   const statusDefaultValue = openedTableModal?.is_active
//     ? 'is_active'
...
//       toast.error(
//         'A mesa só pode ser excluída se todos os pedidos estiverem sido entregue.',
//         {
//           theme: 'light',
//         }
//       );
...
//         <Dialog.Portal>
//           <Dialog.Overlay
//             onClick={() => setIsOpenedTableConfigModal(false)}
//             className="w-screen h-screen flex items-center justify-center bg-black fixed inset-0 z-20 opacity-40 transition-all duration-300 ease-in-out"
//           />
//           <Dialog.Content
//             className={
