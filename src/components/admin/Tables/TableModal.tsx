...
// // import CustomerAtTheTable from './Table/CustomerAtTheTable';
...
//                   onClick={() => setIsOpenedTableConfigModal(true)}
//                 />
//               </div>
//             </Dialog.Title>
...
//                         if (orderProductData.table_id !== openedTableModal!.id)
//                           return;
//                         return (
//                           <CustomerAtTheTable
//                             key={index}
...
//                   h="h-8"
//                   w="w-40"
//                   onClick={() => setIsOpenedProductTableModal(true)}
//                 />
