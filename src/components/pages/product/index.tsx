...
export default function Product() {
    ...
    function chackCategory() {

    }

    return (
        <div className={`w-[345px] pb-9 px-4 bg-white absolute top-0 right-0 z-10 overflow-y-auto shadow-2xl`}>
            <BsArrowLeftCircle
                                            ...
                                            <label key={category.id}>
                                                ...
                                                <div className="w-[99px] h-[94px] rounded-lg relative cursor-pointer "  >
                                                    ...
                                                    <Image
                                                        ...
                                                        className="wi-full h-full relative rounded-lg object-cover contrast-50"
                                                        width={326}
                                                        height={358}
                                                    />
                                                </div>
