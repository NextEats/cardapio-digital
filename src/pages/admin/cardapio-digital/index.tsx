    ...
    <AdminWrapper>
      <div className="flex gap-10">
        <div className="flex flex-col flex-1 ">
          ...
          <NewCategoryModal modalIsOpen={modalIsOpen} editCategory={editCategory} setEditCategory={setEditCategory} setModalIsOpen={setModalIsOpen} />
          <Categories productCategories={productCategories.data} setEditCategory={setEditCategory} />
